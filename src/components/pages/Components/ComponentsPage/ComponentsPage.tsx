...
const ComponentsPage = () => {
	...
	const [isDatetimePickerOpen, isSetDatetimePickerOpen] =
				...
				<ScrollView showsVerticalScrollIndicator={false}>
					<View marginVertical='m'>
						...
						<Section margin='m'>
							...
							<View marginVertical='s'>
								<Button text='Standard Sheet' onPress={standardSheetApi.open} />
							</View>
							<View marginVertical='s'>
								<Button text='Variant Sheet' onPress={variantSheetApi.open} />
							</View>
							<FullScreenDismissableBottomSheet
								sheetApi={fullScreenModalSheetApi}
							>
								<DeclarativeText
									textItems={[
										{
							...
							<BottomSheet sheetRef={standardSheetApi.sheetRef}>
								<View margin='m'>
									...
									<Button text='Dismiss' onPress={standardSheetApi.close} />
								</View>
							</BottomSheet>
							<BottomSheet
								customHandle={() => null}
							...
							>
								<View margin='m'>
									...
									<Button text='Dismiss' onPress={variantSheetApi.close} />
								</View>
							</BottomSheet>
						</Section>
						<Section margin='m'>
							...
							<DatetimePickerWithModal
								...
								toggleModal={() =>
									isSetDatetimePickerOpen(!isDatetimePickerOpen)
								}
						...
						<Section margin='m'>
							...
							<View marginBottom='m'>
								<Button text='Save' variant='outlined' colorVariant='default' />
							</View>
							<View marginBottom='m'>
								<Button text='Save' variant='filled' colorVariant='default' />
							</View>
						</Section>
						<Section marginVertical='m'>
							<View marginHorizontal='m'>
							...
							<SimpleGrid
								...
								renderItem={({ item }) => (
									...
									>
										...
										<Text marginTop='s' variant='paragraph-small'>
											{item}
										</Text>
									</View>
								)}
						...
						<Section margin='m'>
							...
							<Text variant='page-header' color='t1'>
								Text 1
							</Text>
							<Text variant='page-header' color='t2'>
								Text 2
							</Text>
							<Text variant='page-header' color='t3'>
								Text 3
							</Text>

							<Text variant='page-header' color='ion_light'>
								Accent 1 light
							</Text>
							<Text variant='page-header' color='ion'>
								Accent 1 regular
							</Text>
							<Text variant='page-header' color='ion_dark'>
								Accent 1 dark
							</Text>

							<Text variant='page-header' color='matt_light'>
								Accent 2 light
							</Text>
							<Text variant='page-header' color='matt'>
								Accent 2 regular
							</Text>
							<Text variant='page-header' color='matt_dark'>
								Accent 2 dark
							</Text>

							<Text variant='page-header' color='haze_light'>
								Accent 3 light
							</Text>
							<Text variant='page-header' color='haze'>
								Accent 3 regular
							</Text>
							<Text variant='page-header' color='haze_dark'>
								Accent 3 dark
							</Text>

							<Text variant='page-header' color='meteor_light'>
								Accent 4 light
							</Text>
							<Text variant='page-header' color='meteor'>
								Accent 4 regular
							</Text>
							<Text variant='page-header' color='meteor_dark'>
								Accent 4 dark
							</Text>
						</Section>
					</View>
