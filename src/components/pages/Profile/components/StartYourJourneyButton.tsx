...
interface StartYourJourneyButtonProps extends Props<typeof Pressable> {}

const StartYourJourneyButton: React.FC<StartYourJourneyButtonProps> = ({
	...props
}) => {
	return (
		<Pressable {...props}>
...
export default StartYourJourneyButton;
