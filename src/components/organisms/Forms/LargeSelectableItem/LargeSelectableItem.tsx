...
const LargeSelectableItem : React.FC<LargeSelectableItemProps> = ({
    ...
    const setAnimatedValue = (value: number) => animated.value = withTiming(value, { duration: 100 })
    ...
    const animatedIconProps = useAnimatedProps(() => {
        return {
            fill: interpolateColor(animated.value, [0, 1], [theme.colors.t3, theme.colors.t2])
        }
    }, [mode])
