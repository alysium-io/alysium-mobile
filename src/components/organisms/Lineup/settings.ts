...
const calculateLineHeight = (currentContainerType: ContainerType, nextContainerType: ContainerType) => {

    // Otherwise, calculate the height of the line
    return (containerHeightScheme[currentContainerType] / 2) + (containerHeightScheme[nextContainerType] / 2) + CONTAINER_MARGIN_BOTTOM + CONTAINER_MARGIN_TOP
