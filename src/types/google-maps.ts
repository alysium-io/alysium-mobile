/**
 * IMPORTANT!!!
 * This file is a copy of the google-maps-services-js types.
 * You can find it in the SDK at node_modules/@googlemaps/google-maps-services-js/dist/common.d.ts
 *
 * We need these types to interpret some api responses.
 *
...
export enum PlaceType2 {
	...
	/**
	 * indicates a first-order entity below a locality. For some locations may receive one of the additional types:
